...
const MERCHANT_EMAIL = process.env.MERCHANT_EMAIL || 'partnerprogram@rainbowsanddreamsshop.com';
const FROM_EMAIL = process.env.FROM_EMAIL || 'partnerprogram@rainbowsanddreamsshop.com';
